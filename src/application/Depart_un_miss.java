...
public class Depart_un_miss implements Operation{
    ...
    public Etat action(Etat etat) {
        ...
        if (((etatCourant.isBateau() == true) && (1 <= etatCourant.getNbre_missionnaires())) &&
                ((varLoc1 == 0) || (varLoc1 >= varLoc2)) && (((3-varLoc1)==0) || ((3-varLoc1) >= (3-varLoc2)))) {
            return new Etat_can_miss(etatCourant.getNbre_cannibales(), etatCourant.getNbre_missionnaires() - 1, false);
        } else {
            return null;
        }
    }
